      ...
      social: [
        {
          icon: "github",
          label: "GitHub",
          href: "https://github.com/404notfood/artisancms",
        },
      ],
      defaultLocale: "root",
      locales: {
      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: "Types de contenu personnalisés",
              slug: "content/custom-types",
            },
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: "Blocs de mise en page",
              slug: "page-builder/layout-blocks",
            },
            ...
            { label: "Patterns réutilisables", slug: "page-builder/patterns" },
            {
              ...
              slug: "page-builder/dynamic-content",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: "Modèles & Base de données",
              slug: "developer/models-database",
            },
